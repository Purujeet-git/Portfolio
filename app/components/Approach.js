  ...
  return (
    <section className="w-full py-20">
      ...
      <div
        ...
        <Card title="Planning and Stratergy" icon={<AceternityIcon order="Phase-1"/>}
        ...
        <Card AceternityIcon title="Development and Launch" icon={<AceternityIcon order="Phase-3"/>}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] lg:h-[35rem] rounded-3xl group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] ">
      ...
      <div className="relative z-20">
        ...
        <h2
          className="dark:text-white text-3xl opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition text-center duration-200">
          {title}
        </h2>
        <h2
          className="text-sm dark:text-white  opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center" style={{color:'#e4ecff'}}>
          {description}
        </h2>
      </div>
    </div>
